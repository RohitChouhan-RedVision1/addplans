...
//                 <span
//                   className="sub-title animate fadeInUp wow animated"
...
//                 </span>
//                 <h2
//                   className="heading-title animate fadeInUp wow animated"
//                   data-wow-duration="1500ms"
...
//               >
//                 <p className="lead-lg">
//                   Join us on this journey towards your financial freedom. Let&apos;s create a future that&apos;s not just financially sound but also peaceful.
//                 </p>
//                 <p className="lead">
...
//                 <a href="" className="btn btn-primary btn-theme">
//                   <span>G</span><span>e</span><span>t</span><span className="space"></span><span>S</span><span>t</span><span>a</span><span>r</span><span>t</span><span>e</span><span>d</span><span className="space"></span><span>+</span>
//                 </a>
//               </div>
//               <div
                                            ...
                                            <div className='flex justify-between'>
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className='font-bold text-lg text-green-600 w-14 border-none'
                                                    />
                                                </div>
                                            </div>
                                            <Input
                                    ...
                                    <div className='items-center mt-5'>
                                        <div className='flex justify-between'>
                                            ...
                                            <input
                                                ...
                                                className='font-bold text-lg text-green-600 w-8 border-none'
                                            />
                                        </div>
                                        <Input
                                            type="range"
                                ...
                                {isSubmitted ? (
                                    <div className="mb-5 flex justify-between">
                                        <div className="space-x-2">
                                            <Button onClick={() => calculateSip()} className="btn btn-primary"><span>Calculate</span></Button>
                                        </div>
                                        <TooltipProvider>
                                            <Tooltip>
                                    ...
                                    <Dialog open={isModalOpen} onOpenChange={() => handleModelOpen(true)}>
                                        <DialogTrigger asChild>
                                            <Button className="btn btn-primary"><span>Calculate</span></Button>
                                        </DialogTrigger>
                                ...
                                {result && (
                                    <div className="mt-4 flex flex-col justify-center items-center">
                                        <div className="mb-2 text-center flex items-center justify-start gap-3">
                                            ...
                                            <p className="text-2xl">Invested Amount - </p>
                                            {' '}
                                        ...
                                        <div className="mb-5 text-center flex items-center justify-start gap-3">
                                            <div className="w-5 h-5 bg-[var(--rv-secondary)] rounded-lg flex items-center justify-center" />
                                            <p className="text-2xl">Estimated Return - </p>
                                            <p className='text-xl font-bold text-[var(--rv-primary)]'>₹{Math.floor(result.futureValue - result.totalInvestment)?.toLocaleString()}</p>
                                        </div>
                                        <div className="mb-4 text-center">
                                            <p className="text-2xl mb-1">Future value of your investment </p>
                                            <p className='text-2xl font-bold text-[var(--rv-primary)]'>₹{result?.futureValue?.toLocaleString()}</p>
                                        </div>
                                    </div>
                                )}
                            </div>
