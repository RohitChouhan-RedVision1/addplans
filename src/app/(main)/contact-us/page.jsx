      ...
      <div className="max-w-screen-xl mx-auto  py-[30px] md:py-[60px]">
        ...
        <div className="flex  flex-col  gap-4 overflow-hidden rounded-lg mb-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 w-full justify-center items-center text-center">
            <div className="bg-[var(--rv-primary)] text-white p-8 rounded shadow-md w-full md:w-1/3 flex flex-col items-center justify-center min-h-[200px]">
    ...
    <Link href={`${sitedata.mapurl}`} target="_blank" rel="noopener noreferrer">
      ...
      {parts[1]}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {/* Map */}
          <div className="rounded w-full h-[640px] relative border border-gray-200">
            <iframe
              src={sitedata?.iframe}
              width="100%"
              height="100%"
          ...
          <div className="w-full">
            <div className="px-[75px] py-[56px] bg-[var(--rv-white)] animate fadeInRight wow" data-wow-duration="1500ms"
              style={{
