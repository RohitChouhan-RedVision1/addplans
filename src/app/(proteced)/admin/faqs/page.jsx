            ...
            <div className="mb-8 bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="grid grid-cols-1 gap-4">
                    <input
                        ...
                        onChange={(e) => setNewService({ ...newService, question: e.target.value })}
                    />
                    <JoditEditor
                        ref={editor}
                        value={newService.answer}
                        tabIndex={1}
                        onChange={(newContent) => setNewService({ ...newService, answer: newContent })}
                    />
                </div>
                <button
                    className="mt-4 text-sm bg-gray-700 text-white px-5 py-2 rounded-lg hover:bg-gray-800"
                    ...
                    <div key={index} className="bg-white p-6 mb-6 rounded-lg shadow-md">
                        <div className="grid grid-cols-1 gap-4">
                            <input
                                ...
                                onChange={(e) => setNewService({ ...service, question: e.target.value })}
                            />
                            <JoditEditor
                                value={service.answer}
                                tabIndex={1}
                                onChange={(newContent) => handleServiceNameChange(index, newContent)}
